...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog=PROGRAM_NAME, description="Python Language Update Tool"
    )
    ...
    parser.add_argument(
        "--no-summary", action="store_true", help="suppress the summary"
    )
    parser.add_argument(
        "--ts",
        "-ts",
    ...
    parser.add_argument(
        "file", nargs="+", help="the .py or .ui file, or directory to be read"
    )
