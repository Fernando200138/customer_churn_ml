...
from numexpr.necompiler import NumExpr, disassemble, evaluate, re_evaluate, validate
...
def print_versions():
    ...
    try:
        ...
        raise ImportError(
            "`numexpr.tests` could not be imported, likely it was excluded from the distribution."
        )
