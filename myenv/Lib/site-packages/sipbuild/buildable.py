...
class BuildableModule(BuildableFromSources):
    ...
    def __init__(self, project, name, fq_name, *, uses_limited_api=False):
        ...
        super().__init__(
            project, name, fq_name.split(".")[-1], uses_limited_api=uses_limited_api
        )
...
class BuildableBindings(BuildableModule):
    ...
    def get_bindings_installable(self, name):
        ...
        target_subdir = os.path.join(self.project.get_bindings_dir(), self.name)
    ...
    def write_configuration(self, bindings_dir):
        ...
        with open(config_path, "w") as cf:
            ...
            disabled = ", ".join(['"{}"'.format(f) for f in bindings.disabled_features])

            cf.write(
                "# Automatically generated configuration for {0}.\n".format(
                    self.fq_name
                )
            )
            cf.write(
...
""".format(
                    sip_version_str, self.project.abi_version, tags, disabled
                )
            )
