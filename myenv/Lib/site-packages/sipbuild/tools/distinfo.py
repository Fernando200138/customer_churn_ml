...
def main():
    ...
    parser.add_argument(
        "--console-script",
        dest="console_scripts",
        action="append",
        help="the entry point of a console script",
        metavar="ENTRY-POINT",
    )
    ...
    parser.add_argument(
        ...
        dest="gui_scripts",
        action="append",
        help="the entry point of a GUI script",
        metavar="ENTRY-POINT",
    )
    ...
    parser.add_argument(
        "--prefix", help="the installation prefix directory", metavar="DIR"
    )
    ...
    parser.add_argument(
        ...
        dest="requires_dists",
        action="append",
        help="additional Requires-Dist",
        metavar="EXPR",
    )

    parser.add_argument(
        "--wheel-tag", help="the tag if a wheel is being created", metavar="TAG"
    )

    parser.add_argument(
        dest="names",
        nargs=1,
        help="the name of the .dist-info directory",
        metavar="directory",
    )
    ...
    try:
        distinfo(
            name=args.names[0],
            console_scripts=args.console_scripts,
            gui_scripts=args.gui_scripts,
            ...
            requires_dists=args.requires_dists,
