...
class AbstractProject(ABC):
    ...
    def bootstrap(cls, tool, tool_description="", arguments=None):
            ...
            if f_name is not None:
                if not isinstance(f_name, str):
                    raise PyProjectOptionException(
                        value_name,
                        "should be a 'str' and not '{0}'".format(type(f_name).__name__),
        ...
        if not isinstance(project, cls):
            raise UserException(
                "The project factory did not return an AbstractProject " "object"
            )
    ...
    def import_callable(name, base_type):
        ...
        if name.endswith(".py"):
            ...
            try:
                ...
                raise UserException(
                    "Unable to import '{0}'".format(name), detail=str(e)
                )
        else:
            ...
            try:
                ...
                raise UserException(
                    "Unable to import '{0}'".format(module_name), detail=str(e)
                )
        ...
        if object_name is None:
            ...
            for obj in module.__dict__.values():
                ...
                raise UserException(
                    "'{0}' does not define a {1} sub-class".format(
