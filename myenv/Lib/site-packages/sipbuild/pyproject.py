...
class PyProjectOptionException(PyProjectException):
    ...
    def __init__(self, name, text, *, section_name=None, detail=None):
        ...
        super().__init__(
            "'{0}.{1}': {2}".format(section_name, name, text), detail=detail
        )
...
class PyProjectTypeOptionException(PyProjectOptionException):
    ...
    def __init__(self, name, types, *, section_name=None):
        ...
        super().__init__(name, "value must be " + types, section_name=section_name)
...
class PyProject:
    ...
    def __init__(self):
        ...
        try:
            ...
            raise PyProjectException("is not a UTF-8 encoded file", details=str(e))
    ...
    def get_metadata(self):
        ...
        if metadata is None:
            ...
            if "name" not in core_metadata:
                raise PyProjectUndefinedOptionException("name", section_name="project")
        ...
        if "requires-python" not in core_metadata:
            ...
            core_metadata["requires-python"] = ">=3.{}".format(OLDEST_SUPPORTED_MINOR)
            ...
            try:
                ...
                if required:
                    raise PyProjectException(
                        "the '[{0}]' section is missing".format(section_name)
                    )

                return None

        if not self._is_section(section):
            raise PyProjectException("'{0}' is not a section".format(section_name))
    ...
    def _get_legacy_metadata(self):
        ...
        for md_name, md_value in self.get_section(
            "tool.sip.metadata", required=True
        ).items():
            md_name = md_name.lower()
            ...
            if md_name in ("name", "metadata-version"):
                if not isinstance(md_value, str):
                    raise PyProjectTypeOptionException(
                        md_name, "a string", section_name="tool.sip"
                    )
                ...
                if md_name == "name":
                    if not md_value.replace("-", "_").isidentifier():
                        raise PyProjectOptionException(
                            "name",
                            "'{0}' is an invalid project name".format(md_value),
        ...
        if name is None:
            raise PyProjectUndefinedOptionException("name", section_name="tool.sip")
    ...
    def _handle_dependencies(cls, value, core_metadata):
        ...
        if not isinstance(value, list):
            raise PyProjectTypeOptionException(
                "dependencies", "an array of strings", section_name="project"
            )
    ...
    def _handle_keywords(value, core_metadata):
        ...
        if not isinstance(value, list):
            raise PyProjectTypeOptionException(
                "keywords", "an array of strings", section_name="project"
            )
    ...
    def _handle_license(cls, value, core_metadata):
        ...
        try:
            ...
            raise PyProjectTypeOptionException(
                "license", "a valid SPDX license expression", section_name="project"
            )
    ...
    def _handle_legacy_license(value, core_metadata):
        ...
        if text is not None:
            ...
            try:
                ...
                raise PyProjectOptionException(
                    "file", f"unable to read '{file}'", section_name="project.license"
                )
        else:
            raise PyProjectOptionException(
                "readme",
    ...
    def _handle_license_files(value, core_metadata):
        ...
        if not isinstance(value, list):
            raise PyProjectTypeOptionException(
                "license-files", "an array of strings", section_name="project"
            )
    ...
    def _handle_optional_dependencies(cls, value, core_metadata):
        ...
        if not isinstance(value, dict):
            raise PyProjectTypeOptionException(
                "optional-dependencies", "a table", section_name="project"
            )
    ...
    def _handle_people(value, role, core_metadata):
        ...
        if not isinstance(value, list):
            raise PyProjectTypeOptionException(
                key, "an array of tables", section_name="project"
            )
        ...
        for table in value:
            ...
            if name is not None and not isinstance(name, str):
                raise PyProjectOptionException(
                    key, "'name' must be a string", section_name="project"
                )

            if email is not None and not isinstance(email, str):
                raise PyProjectOptionException(
                    key, "'email' must be a string", section_name="project"
                )
        ...
        if isinstance(value, str):
            ...
            if content_type is None:
                raise PyProjectUndefinedOptionException(
                    "content-type", section_name="project.readme"
                )
            ...
            raise PyProjectTypeOptionException(
                "readme", "a string or a table", section_name="project"
            )
    ...
    def _handle_urls(value, core_metadata):
        ...
        if not isinstance(value, dict):
            raise PyProjectTypeOptionException(key, "a table", section_name="project")

        core_metadata["project-url"] = [
            f"{label}, {url}" for label, url in value.items()
        ]
