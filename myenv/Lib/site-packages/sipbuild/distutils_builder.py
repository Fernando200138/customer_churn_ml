...
class DistutilsBuilder(Builder):
    ...
    def build_project(self, target_dir, *, wheel_tag=None):
        ...
        for buildable in project.buildables:
            if isinstance(buildable, BuildableModule):
                if buildable.static:
                    raise UserException("DistutilsBuilder cannot build static modules")
    ...
    def install_project(self, target_dir, *, wheel_tag=None):
        ...
        if project.distinfo:
            ...
            create_distinfo(
                project.get_distinfo_dir(target_dir),
                wheel_tag,
                installed,
                project.metadata,
    ...
    def _build_extension_module(self, buildable):
        ...
        project.progress("Compiling the '{0}' module".format(buildable.fq_name))
        ...
        installable.files.append(module_builder.get_ext_fullpath(buildable.fq_name))
...
class ExtensionCommand(build_ext):
    ...
    def get_ext_filename(self, ext_name):
        ...
        return (
            os.path.join(*ext_name.split(".")) + self._buildable.get_module_extension()
        )
