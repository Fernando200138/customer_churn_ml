...
# installed.
TCL_PREFIX='D:/Documentos/Vida_profesional/Coding/Projects/customer_churn_ml/myenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Documentos/Vida_profesional/Coding/Projects/customer_churn_ml/myenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Documentos/Vida_profesional/Coding/Projects/customer_churn_ml/myenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Documentos/Vida_profesional/Coding/Projects/customer_churn_ml/myenv\Library\include'
...
TCL_PACKAGE_PATH='D:/Documentos/Vida_profesional/Coding/Projects/customer_churn_ml/myenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Documentos/Vida_profesional/Coding/Projects/customer_churn_ml/myenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Documentos/Vida_profesional/Coding/Projects/customer_churn_ml/myenv\Library\lib\tclstub86.lib'
